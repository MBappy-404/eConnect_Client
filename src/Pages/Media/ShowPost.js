...
const ShowPost = ({publicPost, refetch}) => {
     ...
     const {image,post, _id, postUser,postUserPhoto,like} = publicPost;
     ...
     return (
          <div>
               <div class="border w-full  md:w-[400px] lg:w-[500px] bg-white mt-4 m-auto rounded-2xl p-4">
...
<div class="container mx-auto px-2 flex flex-col py-3  justify-center items-center">
  <div class="bg-gray-100 w-full flex items-center p-2 rounded-lg  border">
    <div class="flex items-center">
      <img src={user?.photoURL} alt="My profile" class="w-10 h-10 rounded-full"/>
    </div>
    ...
    <div>
     <p className='text-xs mt-10 text-gray-500' >1 min ago</p>
    </div>
  </div>
